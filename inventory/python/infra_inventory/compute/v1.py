...
class HostResource(betterproto.Message):
    ...
    sol_status: "SolStatus" = betterproto.enum_field(108)
    ...
    sol_session_url: str = betterproto.string_field(111)
    ...
    sol_session_status: "SolSessionStatus" = betterproto.enum_field(112)
