...
class HostResource(betterproto.Message):
    ...
    host_amtconfig: "HostamtconfigResource" = betterproto.message_field(74)
...
@dataclass
class HostamtconfigResource(betterproto.Message):
    resource_id: str = betterproto.string_field(1)
    kind: str = betterproto.string_field(2)
    host: "HostResource" = betterproto.message_field(8)
    version: str = betterproto.string_field(9)
    device_name: str = betterproto.string_field(10)
    operational_state: str = betterproto.string_field(11)
    build_number: str = betterproto.string_field(12)
    sku: str = betterproto.string_field(13)
    features: str = betterproto.string_field(14)
    device_guid: str = betterproto.string_field(15)
    control_mode: str = betterproto.string_field(16)
    dns_suffix: str = betterproto.string_field(17)
    network_status: str = betterproto.string_field(18)
    remote_status: str = betterproto.string_field(19)
    remote_trigger: str = betterproto.string_field(20)
    mps_hostname: str = betterproto.string_field(21)
    tenant_id: str = betterproto.string_field(100)
    created_at: str = betterproto.string_field(200)
    updated_at: str = betterproto.string_field(201)
