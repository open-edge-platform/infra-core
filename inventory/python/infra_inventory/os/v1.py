...
class OperatingSystemResource(betterproto.Message):
    ...
    existing_cves: str = betterproto.string_field(17)
    existing_cves_url: str = betterproto.string_field(18)
    fixed_cves: str = betterproto.string_field(19)
    fixed_cves_url: str = betterproto.string_field(20)
