...
func TestCacheUUIDStoreGetAndInvalidate(t *testing.T) {
	...
	hostAmtconfigT1 := &computev1.HostamtconfigResource{ResourceId: "hostamtconfig-12345678"}
	...
	hostT1.Host.HostAmtconfig = hostAmtconfigT1
	...
	hostAmtconfigT2 := &computev1.HostamtconfigResource{ResourceId: "hostamtconfig-87654321"}
	...
	hostT2.Host.HostAmtconfig = hostAmtconfigT2
...
func TestCacheUUIDInvalidateMultipleKey(t *testing.T) {
	...
	hostAmtconfig := &computev1.HostamtconfigResource{ResourceId: "hostamtconfig-12345678"}
	...
	hostT1.Host.HostAmtconfig = hostAmtconfig
	...
	hostT2.Host.HostAmtconfig = hostAmtconfig
	...
	testcasesT1 := map[string]struct {
		...
		"hostAmtconfigT1": {
			invalidateResID: hostAmtconfig.ResourceId,
		},
	}
...
func TestGetHostResourceIdFromSubRes(t *testing.T) {
	...
	testcases := map[string]struct {
		...
		"hostAmtconfig": {
			res: &inv_v1.Resource{Resource: &inv_v1.Resource_HostAmtconfig{HostAmtconfig: hostAmtconfig}},
		},
	}
