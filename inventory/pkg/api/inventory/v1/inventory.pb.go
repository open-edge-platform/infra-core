...
var file_inventory_v1_inventory_proto_rawDesc = []byte{
	...
	0x2a, 0xfa, 0x05, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4b, 0x69, 0x6e,
	...
	0x01, 0x22, 0x04, 0x08, 0x10, 0x10, 0x10, 0x22, 0x04, 0x08, 0x11, 0x10, 0x11, 0x32, 0x91, 0x0a,
	...
	0x00, 0x12, 0x4e, 0x0a, 0x09, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x12, 0x1e,
	0x2e, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x65,
	0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f,
	0x2e, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x65,
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	29, // 32: inventory.v1.FindResourcesResponse.resources:type_name -> inventory.v1.FindResourcesResponse.ResourceTenantIDCarrier
	...
	30, // 36: inventory.v1.GetResourceResponse.rendered_metadata:type_name -> inventory.v1.GetResourceResponse.ResourceMetadata
	59, // 37: inventory.v1.UpdateResourceRequest.field_mask:type_name -> google.protobuf.FieldMask
	8,  // 38: inventory.v1.UpdateResourceRequest.resource:type_name -> inventory.v1.Resource
	31, // 39: inventory.v1.ListInheritedTelemetryProfilesRequest.inherit_by:type_name -> inventory.v1.ListInheritedTelemetryProfilesRequest.InheritBy
	9,  // 40: inventory.v1.ListInheritedTelemetryProfilesRequest.filter:type_name -> inventory.v1.ResourceFilter
	55, // 41: inventory.v1.ListInheritedTelemetryProfilesResponse.telemetry_profiles:type_name -> telemetry.v1.TelemetryProfile
	33, // 42: inventory.v1.GetTreeHierarchyResponse.tree:type_name -> inventory.v1.GetTreeHierarchyResponse.TreeNode
	34, // 43: inventory.v1.GetSitesPerRegionResponse.regions:type_name -> inventory.v1.GetSitesPerRegionResponse.Node
	...
	32, // 46: inventory.v1.GetTreeHierarchyResponse.TreeNode.current_node:type_name -> inventory.v1.GetTreeHierarchyResponse.Node
	32, // 47: inventory.v1.GetTreeHierarchyResponse.TreeNode.parent_nodes:type_name -> inventory.v1.GetTreeHierarchyResponse.Node
	...
	27, // 60: inventory.v1.InventoryService.Heartbeat:input_type -> inventory.v1.HeartbeatRequest
	...
	28, // 73: inventory.v1.InventoryService.Heartbeat:output_type -> inventory.v1.HeartbeatResponse
