...
type OperatingSystemResource struct {
	...
	ExistingCves      string          `protobuf:"bytes,17,opt,name=existing_cves,json=existingCves,proto3" json:"existing_cves,omitempty"`                                      // JSON string, containig existing CVEs
	ExistingCvesUrl   string          `protobuf:"bytes,18,opt,name=existing_cves_url,json=existingCvesUrl,proto3" json:"existing_cves_url,omitempty"`                           // Location of the open CVEs for the image
	FixedCves         string          `protobuf:"bytes,19,opt,name=fixed_cves,json=fixedCves,proto3" json:"fixed_cves,omitempty"`                                               // JSON string, containig fixed CVEs
	FixedCvesUrl      string          `protobuf:"bytes,20,opt,name=fixed_cves_url,json=fixedCvesUrl,proto3" json:"fixed_cves_url,omitempty"`                                    // Location of the fixed CVEs for the image
...
var file_os_v1_os_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x72, 0x61, 0x69, 0x6e, 0x76, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf1, 0x0b,
	...
	,
	...
	0x22, 0x20, 0x5c, 0x6e, 0x7b, 0x7d, 0x5c, 0x5b, 0x5c, 0x5d, 0x5d, 0x2b, 0x24, 0xba, 0xa6, 0x49,
	0x04, 0x08, 0x01, 0x28, 0x01, 0x52, 0x0c, 0x65, 0x78, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x43,
	0x76, 0x65, 0x73, 0x12, 0x65, 0x0a, 0x11, 0x65, 0x78, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x5f,
	0x63, 0x76, 0x65, 0x73, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x12, 0x20, 0x01, 0x28, 0x09, 0x42, 0x39,
	0xba, 0x48, 0x2e, 0xd8, 0x01, 0x01, 0x72, 0x29, 0x28, 0xf4, 0x03, 0x32, 0x24, 0x5e, 0x24, 0x7c,
	...
	0x24, 0xba, 0xa6, 0x49, 0x04, 0x08, 0x01, 0x28, 0x01, 0x52, 0x0f, 0x65, 0x78, 0x69, 0x73, 0x74,
	0x69, 0x6e, 0x67, 0x43, 0x76, 0x65, 0x73, 0x55, 0x72, 0x6c, 0x12, 0x63, 0x0a, 0x0a, 0x66, 0x69,
	0x78, 0x65, 0x64, 0x5f, 0x63, 0x76, 0x65, 0x73, 0x18, 0x13, 0x20, 0x01, 0x28, 0x09, 0x42, 0x44,
	0xba, 0x48, 0x39, 0xd8, 0x01, 0x01, 0x72, 0x34, 0x28, 0xa0, 0x9c, 0x01, 0x32, 0x2e, 0x5e, 0x24,
	...
	0x20, 0x5c, 0x6e, 0x7b, 0x7d, 0x5c, 0x5b, 0x5c, 0x5d, 0x5d, 0x2b, 0x24, 0xba, 0xa6, 0x49, 0x04,
	0x08, 0x01, 0x28, 0x01, 0x52, 0x09, 0x66, 0x69, 0x78, 0x65, 0x64, 0x43, 0x76, 0x65, 0x73, 0x12,
	0x5f, 0x0a, 0x0e, 0x66, 0x69, 0x78, 0x65, 0x64, 0x5f, 0x63, 0x76, 0x65, 0x73, 0x5f, 0x75, 0x72,
	0x6c, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x42, 0x39, 0xba, 0x48, 0x2e, 0xd8, 0x01, 0x01, 0x72,
	0x29, 0x28, 0xf4, 0x03, 0x32, 0x24, 0x5e, 0x24, 0x7c, 0x5e, 0x5b, 0x61, 0x2d, 0x7a, 0x41, 0x2d,
	...
	0x28, 0x01, 0x52, 0x0c, 0x66, 0x69, 0x78, 0x65, 0x64, 0x43, 0x76, 0x65, 0x73, 0x55, 0x72, 0x6c,
