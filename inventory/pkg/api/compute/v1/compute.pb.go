...
type InstanceResource struct {
	...
	CustomConfig                      []*CustomConfigResource   `protobuf:"bytes,42,rep,name=custom_config,json=customConfig,proto3" json:"custom_config,omitempty"`                                                                                                     // List of Custom Config associated with this Instance
	TenantId                          string                    `protobuf:"bytes,100,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`                                                                                                                // Tenant Identifier
...
var file_compute_v1_compute_proto_rawDesc = []byte{
	...
	0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x22, 0xf0, 0x12, 0x0a, 0x10, 0x49, 0x6e, 0x73, 0x74, 0x61,
	...
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x4b, 0x0a, 0x0d, 0x63, 0x75, 0x73, 0x74, 0x6f,
	0x6d, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x2a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20,
	...
	0x64, 0x41, 0x74, 0x3a, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x22, 0xe1, 0x04, 0x0a, 0x14,
	...
	,
	...
	0x4e, 0x4f, 0x44, 0x45, 0x10, 0x01, 0x42, 0x54, 0x5a, 0x52, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_compute_v1_compute_proto_goTypes = []interface{}{
	...
	(*CustomConfigResource)(nil),        // 20: compute.v1.CustomConfigResource
	(*v1.SiteResource)(nil),             // 21: location.v1.SiteResource
	(*v11.ProviderResource)(nil),        // 22: provider.v1.ProviderResource
	(v12.StatusIndication)(0),           // 23: status.v1.StatusIndication
	(*v13.OperatingSystemResource)(nil), // 24: os.v1.OperatingSystemResource
	(v13.SecurityFeature)(0),            // 25: os.v1.SecurityFeature
	(*v14.LocalAccountResource)(nil),    // 26: localaccount.v1.LocalAccountResource
}
var file_compute_v1_compute_proto_depIdxs = []int32{
	...
	21, // 2: compute.v1.HostResource.site:type_name -> location.v1.SiteResource
	22, // 3: compute.v1.HostResource.provider:type_name -> provider.v1.ProviderResource
	...
	23, // 7: compute.v1.HostResource.power_status_indicator:type_name -> status.v1.StatusIndication
	2,  // 8: compute.v1.HostResource.power_command_policy:type_name -> compute.v1.PowerCommandPolicy
	23, // 9: compute.v1.HostResource.host_status_indicator:type_name -> status.v1.StatusIndication
	23, // 10: compute.v1.HostResource.onboarding_status_indicator:type_name -> status.v1.StatusIndication
	23, // 11: compute.v1.HostResource.registration_status_indicator:type_name -> status.v1.StatusIndication
	13, // 12: compute.v1.HostResource.host_storages:type_name -> compute.v1.HoststorageResource
	14, // 13: compute.v1.HostResource.host_nics:type_name -> compute.v1.HostnicResource
	15, // 14: compute.v1.HostResource.host_usbs:type_name -> compute.v1.HostusbResource
	16, // 15: compute.v1.HostResource.host_gpus:type_name -> compute.v1.HostgpuResource
	17, // 16: compute.v1.HostResource.instance:type_name -> compute.v1.InstanceResource
	...
	23, // 19: compute.v1.HostResource.amt_status_indicator:type_name -> status.v1.StatusIndication
	12, // 20: compute.v1.HoststorageResource.host:type_name -> compute.v1.HostResource
	12, // 21: compute.v1.HostnicResource.host:type_name -> compute.v1.HostResource
	6,  // 22: compute.v1.HostnicResource.link_state:type_name -> compute.v1.NetworkInterfaceLinkState
	12, // 23: compute.v1.HostusbResource.host:type_name -> compute.v1.HostResource
	12, // 24: compute.v1.HostgpuResource.host:type_name -> compute.v1.HostResource
	...
	12, // 28: compute.v1.InstanceResource.host:type_name -> compute.v1.HostResource
	24, // 29: compute.v1.InstanceResource.desired_os:type_name -> os.v1.OperatingSystemResource
	24, // 30: compute.v1.InstanceResource.current_os:type_name -> os.v1.OperatingSystemResource
	25, // 31: compute.v1.InstanceResource.security_feature:type_name -> os.v1.SecurityFeature
	23, // 32: compute.v1.InstanceResource.instance_status_indicator:type_name -> status.v1.StatusIndication
	23, // 33: compute.v1.InstanceResource.provisioning_status_indicator:type_name -> status.v1.StatusIndication
	23, // 34: compute.v1.InstanceResource.update_status_indicator:type_name -> status.v1.StatusIndication
	23, // 35: compute.v1.InstanceResource.trusted_attestation_status_indicator:type_name -> status.v1.StatusIndication
	19, // 36: compute.v1.InstanceResource.workload_members:type_name -> compute.v1.WorkloadMember
	22, // 37: compute.v1.InstanceResource.provider:type_name -> provider.v1.ProviderResource
	26, // 38: compute.v1.InstanceResource.localaccount:type_name -> localaccount.v1.LocalAccountResource
	20, // 39: compute.v1.InstanceResource.custom_config:type_name -> compute.v1.CustomConfigResource
	...
	19, // 43: compute.v1.WorkloadResource.members:type_name -> compute.v1.WorkloadMember
	11, // 44: compute.v1.WorkloadMember.kind:type_name -> compute.v1.WorkloadMemberKind
	18, // 45: compute.v1.WorkloadMember.workload:type_name -> compute.v1.WorkloadResource
	17, // 46: compute.v1.WorkloadMember.instance:type_name -> compute.v1.InstanceResource
	17, // 47: compute.v1.CustomConfigResource.instances:type_name -> compute.v1.InstanceResource
