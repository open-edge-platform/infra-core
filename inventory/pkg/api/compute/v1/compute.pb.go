...
type InstanceResource struct {
	...
	CustomConfig                      []*CustomConfigResource   `protobuf:"bytes,44,rep,name=custom_config,json=customConfig,proto3" json:"custom_config,omitempty"`                                                                                                     // List of Custom Config associated with this Instance
	TenantId                          string                    `protobuf:"bytes,100,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`                                                                                                                // Tenant Identifier
...
var file_compute_v1_compute_proto_rawDesc = []byte{
	...
	0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x22, 0xb5, 0x14, 0x0a, 0x10, 0x49, 0x6e, 0x73, 0x74, 0x61,
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x4b, 0x0a, 0x0d,
	0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x2c, 0x20,
	...
	0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x00, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x2a, 0x94,
...
var file_compute_v1_compute_proto_depIdxs = []int32{
	...
	22, // 40: compute.v1.InstanceResource.custom_config:type_name -> compute.v1.CustomConfigResource
	...
	18, // 50: compute.v1.CustomConfigResource.instances:type_name -> compute.v1.InstanceResource
