...
type CustomConfigResource struct {
	...
	UpdatedAt string              `protobuf:"bytes,201,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"` // Update timestamp
	Instances []*InstanceResource `protobuf:"bytes,500,rep,name=instances,proto3" json:"instances,omitempty"`                  // back-reference to the Instances associated to this Custom Config
}
...
var file_compute_v1_compute_proto_rawDesc = []byte{
	...
	0x12, 0x56, 0x0a, 0x0d, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x18, 0x2a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x75, 0x74,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x0f, 0xc2, 0xa6, 0x49, 0x0b, 0x12,
	0x09, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x52, 0x0c, 0x63, 0x75, 0x73, 0x74,
	...
	0x99, 0x04, 0x0a, 0x14, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x3e, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x49, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x31, 0xba, 0x48, 0x26, 0xd8, 0x01, 0x01, 0x72,
	0x21, 0x10, 0x01, 0x18, 0x80, 0x80, 0x01, 0x32, 0x19, 0x5e, 0x5b, 0x41, 0x2d, 0x5a, 0x61, 0x2d,
	0x7a, 0x30, 0x2d, 0x39, 0x2d, 0x2f, 0x5f, 0x5c, 0x5b, 0x5c, 0x5d, 0x5c, 0x2e, 0x5c, 0x5c, 0x5d,
	0x2a, 0x24, 0xba, 0xa6, 0x49, 0x04, 0x08, 0x00, 0x28, 0x01, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x41, 0x0a, 0x09, 0x69, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x73, 0x18, 0xf4, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x63,
	0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	0x63, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x04, 0xc2, 0xa6, 0x49, 0x00,
	...
	0x5f, 0x69, 0x64, 0x18, 0x00, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x2a, 0xa7, 0x01, 0x0a, 0x09,
	...
	0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x17, 0x0a, 0x13, 0x48, 0x4f, 0x53, 0x54, 0x5f, 0x53, 0x54,
	0x41, 0x54, 0x45, 0x5f, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x01, 0x12, 0x16,
	...
	0x52, 0x45, 0x44, 0x10, 0x05, 0x2a, 0x69, 0x0a, 0x0a, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x53, 0x74,
	...
	0x43, 0x4c, 0x55, 0x53, 0x54, 0x45, 0x52, 0x5f, 0x4e, 0x4f, 0x44, 0x45, 0x10, 0x01, 0x42, 0x54,
...
var file_compute_v1_compute_proto_goTypes = []interface{}{
	...
	(*CustomConfigResource)(nil),        // 18: compute.v1.CustomConfigResource
	(*v1.SiteResource)(nil),             // 19: location.v1.SiteResource
	(*v11.ProviderResource)(nil),        // 20: provider.v1.ProviderResource
	(v12.StatusIndication)(0),           // 21: status.v1.StatusIndication
	(*v13.OperatingSystemResource)(nil), // 22: os.v1.OperatingSystemResource
	(v13.SecurityFeature)(0),            // 23: os.v1.SecurityFeature
	(*v14.LocalAccountResource)(nil),    // 24: localaccount.v1.LocalAccountResource
}
var file_compute_v1_compute_proto_depIdxs = []int32{
	...
	19, // 2: compute.v1.HostResource.site:type_name -> location.v1.SiteResource
	20, // 3: compute.v1.HostResource.provider:type_name -> provider.v1.ProviderResource
	...
	21, // 7: compute.v1.HostResource.host_status_indicator:type_name -> status.v1.StatusIndication
	21, // 8: compute.v1.HostResource.onboarding_status_indicator:type_name -> status.v1.StatusIndication
	21, // 9: compute.v1.HostResource.registration_status_indicator:type_name -> status.v1.StatusIndication
	...
	22, // 24: compute.v1.InstanceResource.desired_os:type_name -> os.v1.OperatingSystemResource
	22, // 25: compute.v1.InstanceResource.current_os:type_name -> os.v1.OperatingSystemResource
	23, // 26: compute.v1.InstanceResource.security_feature:type_name -> os.v1.SecurityFeature
	21, // 27: compute.v1.InstanceResource.instance_status_indicator:type_name -> status.v1.StatusIndication
	21, // 28: compute.v1.InstanceResource.provisioning_status_indicator:type_name -> status.v1.StatusIndication
	21, // 29: compute.v1.InstanceResource.update_status_indicator:type_name -> status.v1.StatusIndication
	21, // 30: compute.v1.InstanceResource.trusted_attestation_status_indicator:type_name -> status.v1.StatusIndication
	17, // 31: compute.v1.InstanceResource.workload_members:type_name -> compute.v1.WorkloadMember
	20, // 32: compute.v1.InstanceResource.provider:type_name -> provider.v1.ProviderResource
	24, // 33: compute.v1.InstanceResource.localaccount:type_name -> localaccount.v1.LocalAccountResource
	18, // 34: compute.v1.InstanceResource.custom_config:type_name -> compute.v1.CustomConfigResource
	...
	15, // 42: compute.v1.CustomConfigResource.instances:type_name -> compute.v1.InstanceResource
