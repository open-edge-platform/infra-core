...
const (
	SolSessionStatus_SOL_SESSION_STATUS_UNSPECIFIED SolSessionStatus = 0
	SolSessionStatus_SOL_SESSION_STATUS_ACTIVATED   SolSessionStatus = 1 // SOL session is currently active.
	SolSessionStatus_SOL_SESSION_STATUS_DEACTIVATED SolSessionStatus = 2 // SOL session is currently inactive.
)

// Enum value maps for SolSessionStatus.
var (
	SolSessionStatus_name = map[int32]string{
		0: "SOL_SESSION_STATUS_UNSPECIFIED",
		1: "SOL_SESSION_STATUS_ACTIVATED",
		2: "SOL_SESSION_STATUS_DEACTIVATED",
	}
...
func (InstanceKind) Descriptor() protoreflect.EnumDescriptor {
	return file_compute_v1_compute_proto_enumTypes[13].Descriptor()
}

func (InstanceKind) Type() protoreflect.EnumType {
	return &file_compute_v1_compute_proto_enumTypes[13]
}
...
func (WorkloadState) Descriptor() protoreflect.EnumDescriptor {
	return file_compute_v1_compute_proto_enumTypes[14].Descriptor()
}

func (WorkloadState) Type() protoreflect.EnumType {
	return &file_compute_v1_compute_proto_enumTypes[14]
}
...
func (WorkloadKind) Descriptor() protoreflect.EnumDescriptor {
	return file_compute_v1_compute_proto_enumTypes[15].Descriptor()
}

func (WorkloadKind) Type() protoreflect.EnumType {
	return &file_compute_v1_compute_proto_enumTypes[15]
}
...
func (WorkloadMemberKind) Descriptor() protoreflect.EnumDescriptor {
	return file_compute_v1_compute_proto_enumTypes[16].Descriptor()
}

func (WorkloadMemberKind) Type() protoreflect.EnumType {
	return &file_compute_v1_compute_proto_enumTypes[16]
}
...
func (UpdatePolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_compute_v1_compute_proto_enumTypes[17].Descriptor()
}

func (UpdatePolicy) Type() protoreflect.EnumType {
	return &file_compute_v1_compute_proto_enumTypes[17]
}
...
type HostResource struct {
	...
	AmtSku                      AmtSku                 `protobuf:"varint,91,opt,name=amt_sku,json=amtSku,proto3,enum=compute.v1.AmtSku" json:"amt_sku,omitempty"`                                                                           // coming from device introspection
	...
	SolStatus SolStatus `protobuf:"varint,108,opt,name=sol_status,json=solStatus,proto3,enum=compute.v1.SolStatus" json:"sol_status,omitempty"`
	...
	DesiredSolState SolState `protobuf:"varint,109,opt,name=desired_sol_state,json=desiredSolState,proto3,enum=compute.v1.SolState" json:"desired_sol_state,omitempty"`
	// Current SOL session state. Set by sol-manager RM only.
	// Lifecycle: UNSPECIFIED → START → [AWAITING_CONSENT → START] | STOP | ERROR.
	CurrentSolState SolState `protobuf:"varint,110,opt,name=current_sol_state,json=currentSolState,proto3,enum=compute.v1.SolState" json:"current_sol_state,omitempty"`
	...
	SolSessionStatus SolSessionStatus `protobuf:"varint,112,opt,name=sol_session_status,json=solSessionStatus,proto3,enum=compute.v1.SolSessionStatus" json:"sol_session_status,omitempty"`
	// Indicates the severity/dynamicity of sol_session_status (e.g. IDLE, IN_PROGRESS, ERROR).
	// Set by sol-manager RM only.
	SolSessionStatusIndicator v12.StatusIndication `protobuf:"varint,113,opt,name=sol_session_status_indicator,json=solSessionStatusIndicator,proto3,enum=status.v1.StatusIndication" json:"sol_session_status_indicator,omitempty"`
...
func (x *HostResource) GetSolSessionStatus() SolSessionStatus {
	...
	return SolSessionStatus_SOL_SESSION_STATUS_UNSPECIFIED
}
...
type OSUpdatePolicyResource struct {
	...
	UpdatePackages      string                       `protobuf:"bytes,7,opt,name=update_packages,json=updatePackages,proto3" json:"update_packages,omitempty"`                          // Freeform text, OS-dependent. A list of package names, one per line (newline separated). Should not contain version info. Applies only to Mutable OSes.
	UpdateKernelCommand string                       `protobuf:"bytes,8,opt,name=update_kernel_command,json=updateKernelCommand,proto3" json:"update_kernel_command,omitempty"`         // Kernel Command Line Options. Applies only to Mutable OSes.
...
func (x *OSUpdatePolicyResource) GetUpdatePackages() string {
	if x != nil {
...
func (x *OSUpdatePolicyResource) GetUpdateKernelCommand() string {
	if x != nil {
...
var file_compute_v1_compute_proto_rawDesc = []byte{
	...
	0x22, 0x8d, 0x22, 0x0a, 0x0c, 0x48, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	0x63, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x61, 0x6d, 0x74, 0x5f, 0x73, 0x6b, 0x75, 0x18, 0x5b, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x2e, 0x76, 0x31,
	0x2e, 0x41, 0x6d, 0x74, 0x53, 0x6b, 0x75, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52,
	0x06, 0x61, 0x6d, 0x74, 0x53, 0x6b, 0x75, 0x12, 0x48, 0x0a, 0x11, 0x64, 0x65, 0x73, 0x69, 0x72,
	0x65, 0x64, 0x5f, 0x61, 0x6d, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x5c, 0x20, 0x01,
	...
	0x52, 0x0f, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x41, 0x6d, 0x74, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x12, 0x48, 0x0a, 0x11, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x6d, 0x74,
	0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x5d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x63,
	0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x6d, 0x74, 0x53, 0x74, 0x61,
	0x74, 0x65, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x0f, 0x63, 0x75, 0x72, 0x72,
	0x65, 0x6e, 0x74, 0x41, 0x6d, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x30, 0x0a, 0x0a, 0x61,
	...
	0x08, 0x01, 0x52, 0x09, 0x61, 0x6d, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x55, 0x0a,
	0x14, 0x61, 0x6d, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x69, 0x6e, 0x64, 0x69,
	0x63, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x5f, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x73, 0x74,
	...
	,
	...
	,
	...
	0x74, 0x75, 0x73, 0x12, 0x36, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28,
	...
	,
	...
	0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x00, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x4a, 0x04,
	0x08, 0x08, 0x10, 0x0b, 0x22, 0x95, 0x0a, 0x0a, 0x0f, 0x48, 0x6f, 0x73, 0x74, 0x6e, 0x69, 0x63,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x48, 0x0a, 0x0b, 0x72, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x27, 0xba,
	0x48, 0x1e, 0xd8, 0x01, 0x01, 0x72, 0x19, 0x28, 0x10, 0x32, 0x15, 0x5e, 0x68, 0x6f, 0x73, 0x74,
	0x6e, 0x69, 0x63, 0x2d, 0x5b, 0x30, 0x2d, 0x39, 0x61, 0x2d, 0x66, 0x5d, 0x7b, 0x38, 0x7d, 0x24,
	...
	0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x2f,
	0x0a, 0x0f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52,
	0x0e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	0x36, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	...
	,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x09, 0x6c,
	0x69, 0x6e, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x2b, 0x0a, 0x0d, 0x62, 0x6d, 0x63, 0x5f,
	0x69, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x18, 0x2b, 0x20, 0x01, 0x28, 0x08, 0x42,
	0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x0c, 0x62, 0x6d, 0x63, 0x49, 0x6e, 0x74, 0x65,
	0x72, 0x66, 0x61, 0x63, 0x65, 0x12, 0x32, 0x0a, 0x09, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x5f,
	...
	,
	...
	,
	...
	,
	...
	0x18, 0x00, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x22, 0xc9, 0x14, 0x0a, 0x10, 0x49, 0x6e, 0x73,
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x45, 0x0a,
	0x0b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x24, 0xba, 0x48, 0x1b, 0xd8, 0x01, 0x01, 0x72, 0x16, 0x28, 0x0d, 0x32, 0x12,
	...
	0x63, 0x65, 0x49, 0x64, 0x12, 0x34, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x18, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x4b, 0x69, 0x6e, 0x64, 0x42, 0x06, 0xba, 0xa6,
	0x49, 0x02, 0x08, 0x01, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x1a, 0x0a, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01,
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x46, 0x0a, 0x0d, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65,
	...
	,
	...
	0x75, 0x72, 0x63, 0x65, 0x42, 0x08, 0xc2, 0xa6, 0x49, 0x04, 0x08, 0x01, 0x18, 0x01, 0x52, 0x02,
	...
	,
	...
	,
	...
	0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x51, 0x0a, 0x0c, 0x6c, 0x6f, 0x63, 0x61,
	0x6c, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x29, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25,
	...
	,
	...
	,
	...
	0x74, 0x49, 0x64, 0x12, 0x6c, 0x0a, 0x16, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x18, 0x65, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x36, 0xba, 0x48, 0x2d, 0xd8, 0x01, 0x01, 0x72, 0x28, 0x18, 0x80, 0x08,
	...
	0x29, 0x20, 0x5d, 0x2b, 0x24, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x14, 0x69, 0x6e, 0x73,
	...
	,
	...
	,
	...
	,
	...
	0x28, 0x09, 0x42, 0x1f, 0xba, 0xa6, 0x49, 0x1b, 0x08, 0x00, 0x28, 0x00, 0x4a, 0x15, 0x0a, 0x08,
	0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x12, 0x09, 0x54, 0x49, 0x4d, 0x45, 0x53, 0x54,
	0x41, 0x4d, 0x50, 0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x3a, 0x06,
	0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x22, 0x99, 0x07, 0x0a, 0x16, 0x4f, 0x53, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x12, 0x4f, 0x0a, 0x0b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2e, 0xba, 0x48, 0x25, 0xd8, 0x01, 0x01, 0x72, 0x20,
	...
	,
	...
	,
	...
	0x48, 0x2e, 0x72, 0x2c, 0x18, 0xa0, 0xc2, 0x1e, 0x32, 0x26, 0x5e, 0x24, 0x7c, 0x5e, 0x5b, 0x61,
	0x2d, 0x7a, 0x41, 0x2d, 0x5a, 0x2d, 0x5f, 0x30, 0x2d, 0x39, 0x2e, 0x2f, 0x3a, 0x3b, 0x3d, 0x40,
	0x3f, 0x21, 0x23, 0x2c, 0x3c, 0x3e, 0x2a, 0x28, 0x29, 0x22, 0x20, 0x5c, 0x0a, 0x5d, 0x2b, 0x24,
	0xba, 0xa6, 0x49, 0x04, 0x08, 0x01, 0x28, 0x01, 0x52, 0x0e, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x73, 0x12, 0x6a, 0x0a, 0x15, 0x75, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x5f, 0x6b, 0x65, 0x72, 0x6e, 0x65, 0x6c, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e,
	0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x42, 0x36, 0xba, 0x48, 0x2b, 0x72, 0x29, 0x18, 0xf4,
	...
	0x28, 0x29, 0x22, 0x20, 0x5d, 0x2b, 0x24, 0xba, 0xa6, 0x49, 0x04, 0x08, 0x01, 0x28, 0x01, 0x52,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x48, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x34, 0xba, 0x48, 0x29, 0x72, 0x27, 0x28, 0x28,
	0x32, 0x23, 0x5e, 0x24, 0x7c, 0x5e, 0x5b, 0x61, 0x2d, 0x7a, 0x41, 0x2d, 0x5a, 0x2d, 0x5f, 0x30,
	0x2d, 0x39, 0x2e, 0x2f, 0x3a, 0x3b, 0x3d, 0x3f, 0x40, 0x21, 0x23, 0x2c, 0x3c, 0x3e, 0x2a, 0x28,
	0x29, 0x20, 0x5d, 0x2b, 0x24, 0xba, 0xa6, 0x49, 0x04, 0x08, 0x01, 0x28, 0x01, 0x52, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x12, 0x57, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x35, 0xba, 0x48, 0x2a, 0x72, 0x28, 0x28,
	...
	0x2a, 0x28, 0x29, 0x20, 0x5d, 0x2b, 0x24, 0xba, 0xa6, 0x49, 0x04, 0x08, 0x01, 0x28, 0x01, 0x52,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x2e, 0x76,
	...
	0x18, 0x00, 0x52, 0x0d, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x12, 0x42, 0x0a, 0x08, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x05, 0x20,
	...
	,
	...
	0x65, 0x64, 0x41, 0x74, 0x3a, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x2a, 0x94, 0x01, 0x0a,
	...
	0x5f, 0x52, 0x45, 0x47, 0x49, 0x53, 0x54, 0x45, 0x52, 0x45, 0x44, 0x10, 0x05, 0x22, 0x04, 0x08,
	0x01, 0x10, 0x01, 0x2a, 0xdc, 0x01, 0x0a, 0x0a, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	0x06, 0x12, 0x1b, 0x0a, 0x17, 0x50, 0x4f, 0x57, 0x45, 0x52, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45,
	0x5f, 0x50, 0x4f, 0x57, 0x45, 0x52, 0x5f, 0x43, 0x59, 0x43, 0x4c, 0x45, 0x10, 0x07, 0x12, 0x1c,
	0x0a, 0x18, 0x50, 0x4f, 0x57, 0x45, 0x52, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x52, 0x45,
	0x53, 0x45, 0x54, 0x5f, 0x52, 0x45, 0x50, 0x45, 0x41, 0x54, 0x10, 0x08, 0x22, 0x04, 0x08, 0x01,
	...
	0x52, 0x45, 0x44, 0x10, 0x02, 0x2a, 0xd3, 0x01, 0x0a, 0x17, 0x42, 0x61, 0x72, 0x65, 0x6d, 0x65,
	...
	0x5f, 0x4b, 0x49, 0x4e, 0x44, 0x5f, 0x50, 0x44, 0x55, 0x10, 0x04, 0x2a, 0x79, 0x0a, 0x08, 0x41,
	...
	,
	...
	0x49, 0x53, 0x54, 0x53, 0x10, 0x03, 0x2a, 0x95, 0x01, 0x0a, 0x19, 0x4e, 0x65, 0x74, 0x77, 0x6f,
	...
	0x53, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x5c, 0x0a, 0x0c, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	...
	0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x14, 0x0a, 0x10, 0x49, 0x4e, 0x53, 0x54, 0x41, 0x4e, 0x43,
	0x45, 0x5f, 0x4b, 0x49, 0x4e, 0x44, 0x5f, 0x56, 0x4d, 0x10, 0x01, 0x12, 0x17, 0x0a, 0x13, 0x49,
	...
	0x49, 0x53, 0x49, 0x4f, 0x4e, 0x45, 0x44, 0x10, 0x04, 0x2a, 0x60, 0x0a, 0x0c, 0x57, 0x6f, 0x72,
	...
	0x52, 0x10, 0x01, 0x12, 0x16, 0x0a, 0x12, 0x57, 0x4f, 0x52, 0x4b, 0x4c, 0x4f, 0x41, 0x44, 0x5f,
	0x4b, 0x49, 0x4e, 0x44, 0x5f, 0x44, 0x48, 0x43, 0x50, 0x10, 0x02, 0x2a, 0x61, 0x0a, 0x12, 0x57,
...
var file_compute_v1_compute_proto_enumTypes = make([]protoimpl.EnumInfo, 18)
...
var file_compute_v1_compute_proto_goTypes = []interface{}{
	...
	(AmtSku)(0),                         // 5: compute.v1.AmtSku
	(AmtControlMode)(0),                 // 6: compute.v1.AmtControlMode
	(SolStatus)(0),                      // 7: compute.v1.SolStatus
	(SolSessionStatus)(0),               // 8: compute.v1.SolSessionStatus
	(SolState)(0),                       // 9: compute.v1.SolState
	(HostComponentState)(0),             // 10: compute.v1.HostComponentState
	(NetworkInterfaceLinkState)(0),      // 11: compute.v1.NetworkInterfaceLinkState
	(InstanceState)(0),                  // 12: compute.v1.InstanceState
	(InstanceKind)(0),                   // 13: compute.v1.InstanceKind
	(WorkloadState)(0),                  // 14: compute.v1.WorkloadState
	(WorkloadKind)(0),                   // 15: compute.v1.WorkloadKind
	(WorkloadMemberKind)(0),             // 16: compute.v1.WorkloadMemberKind
	(UpdatePolicy)(0),                   // 17: compute.v1.UpdatePolicy
	(*HostResource)(nil),                // 18: compute.v1.HostResource
	(*HoststorageResource)(nil),         // 19: compute.v1.HoststorageResource
	(*HostnicResource)(nil),             // 20: compute.v1.HostnicResource
	(*HostusbResource)(nil),             // 21: compute.v1.HostusbResource
	(*HostgpuResource)(nil),             // 22: compute.v1.HostgpuResource
	(*InstanceResource)(nil),            // 23: compute.v1.InstanceResource
	(*WorkloadResource)(nil),            // 24: compute.v1.WorkloadResource
	(*WorkloadMember)(nil),              // 25: compute.v1.WorkloadMember
	(*OSUpdatePolicyResource)(nil),      // 26: compute.v1.OSUpdatePolicyResource
	(*CustomConfigResource)(nil),        // 27: compute.v1.CustomConfigResource
	(*OSUpdateRunResource)(nil),         // 28: compute.v1.OSUpdateRunResource
	(*v1.SiteResource)(nil),             // 29: location.v1.SiteResource
	(*v11.ProviderResource)(nil),        // 30: provider.v1.ProviderResource
	(v12.StatusIndication)(0),           // 31: status.v1.StatusIndication
	(*v13.OperatingSystemResource)(nil), // 32: os.v1.OperatingSystemResource
	(v13.SecurityFeature)(0),            // 33: os.v1.SecurityFeature
	(*v14.LocalAccountResource)(nil),    // 34: localaccount.v1.LocalAccountResource
}
var file_compute_v1_compute_proto_depIdxs = []int32{
	...
	29, // 2: compute.v1.HostResource.site:type_name -> location.v1.SiteResource
	30, // 3: compute.v1.HostResource.provider:type_name -> provider.v1.ProviderResource
	...
	31, // 7: compute.v1.HostResource.power_status_indicator:type_name -> status.v1.StatusIndication
	2,  // 8: compute.v1.HostResource.power_command_policy:type_name -> compute.v1.PowerCommandPolicy
	31, // 9: compute.v1.HostResource.host_status_indicator:type_name -> status.v1.StatusIndication
	31, // 10: compute.v1.HostResource.onboarding_status_indicator:type_name -> status.v1.StatusIndication
	31, // 11: compute.v1.HostResource.registration_status_indicator:type_name -> status.v1.StatusIndication
	19, // 12: compute.v1.HostResource.host_storages:type_name -> compute.v1.HoststorageResource
	20, // 13: compute.v1.HostResource.host_nics:type_name -> compute.v1.HostnicResource
	21, // 14: compute.v1.HostResource.host_usbs:type_name -> compute.v1.HostusbResource
	22, // 15: compute.v1.HostResource.host_gpus:type_name -> compute.v1.HostgpuResource
	23, // 16: compute.v1.HostResource.instance:type_name -> compute.v1.InstanceResource
	5,  // 17: compute.v1.HostResource.amt_sku:type_name -> compute.v1.AmtSku
	4,  // 18: compute.v1.HostResource.desired_amt_state:type_name -> compute.v1.AmtState
	4,  // 19: compute.v1.HostResource.current_amt_state:type_name -> compute.v1.AmtState
	31, // 20: compute.v1.HostResource.amt_status_indicator:type_name -> status.v1.StatusIndication
	6,  // 21: compute.v1.HostResource.amt_control_mode:type_name -> compute.v1.AmtControlMode
	7,  // 22: compute.v1.HostResource.sol_status:type_name -> compute.v1.SolStatus
	9,  // 23: compute.v1.HostResource.desired_sol_state:type_name -> compute.v1.SolState
	9,  // 24: compute.v1.HostResource.current_sol_state:type_name -> compute.v1.SolState
	8,  // 25: compute.v1.HostResource.sol_session_status:type_name -> compute.v1.SolSessionStatus
	31, // 26: compute.v1.HostResource.sol_session_status_indicator:type_name -> status.v1.StatusIndication
	18, // 27: compute.v1.HoststorageResource.host:type_name -> compute.v1.HostResource
	18, // 28: compute.v1.HostnicResource.host:type_name -> compute.v1.HostResource
	11, // 29: compute.v1.HostnicResource.link_state:type_name -> compute.v1.NetworkInterfaceLinkState
	18, // 30: compute.v1.HostusbResource.host:type_name -> compute.v1.HostResource
	18, // 31: compute.v1.HostgpuResource.host:type_name -> compute.v1.HostResource
	13, // 32: compute.v1.InstanceResource.kind:type_name -> compute.v1.InstanceKind
	12, // 33: compute.v1.InstanceResource.desired_state:type_name -> compute.v1.InstanceState
	12, // 34: compute.v1.InstanceResource.current_state:type_name -> compute.v1.InstanceState
	18, // 35: compute.v1.InstanceResource.host:type_name -> compute.v1.HostResource
	32, // 36: compute.v1.InstanceResource.os:type_name -> os.v1.OperatingSystemResource
	33, // 37: compute.v1.InstanceResource.security_feature:type_name -> os.v1.SecurityFeature
	31, // 38: compute.v1.InstanceResource.instance_status_indicator:type_name -> status.v1.StatusIndication
	31, // 39: compute.v1.InstanceResource.provisioning_status_indicator:type_name -> status.v1.StatusIndication
	31, // 40: compute.v1.InstanceResource.update_status_indicator:type_name -> status.v1.StatusIndication
	31, // 41: compute.v1.InstanceResource.trusted_attestation_status_indicator:type_name -> status.v1.StatusIndication
	25, // 42: compute.v1.InstanceResource.workload_members:type_name -> compute.v1.WorkloadMember
	30, // 43: compute.v1.InstanceResource.provider:type_name -> provider.v1.ProviderResource
	34, // 44: compute.v1.InstanceResource.localaccount:type_name -> localaccount.v1.LocalAccountResource
	26, // 45: compute.v1.InstanceResource.os_update_policy:type_name -> compute.v1.OSUpdatePolicyResource
	27, // 46: compute.v1.InstanceResource.custom_config:type_name -> compute.v1.CustomConfigResource
	15, // 47: compute.v1.WorkloadResource.kind:type_name -> compute.v1.WorkloadKind
	14, // 48: compute.v1.WorkloadResource.desired_state:type_name -> compute.v1.WorkloadState
	14, // 49: compute.v1.WorkloadResource.current_state:type_name -> compute.v1.WorkloadState
	25, // 50: compute.v1.WorkloadResource.members:type_name -> compute.v1.WorkloadMember
	16, // 51: compute.v1.WorkloadMember.kind:type_name -> compute.v1.WorkloadMemberKind
	24, // 52: compute.v1.WorkloadMember.workload:type_name -> compute.v1.WorkloadResource
	23, // 53: compute.v1.WorkloadMember.instance:type_name -> compute.v1.InstanceResource
	32, // 54: compute.v1.OSUpdatePolicyResource.target_os:type_name -> os.v1.OperatingSystemResource
	17, // 55: compute.v1.OSUpdatePolicyResource.update_policy:type_name -> compute.v1.UpdatePolicy
	23, // 56: compute.v1.CustomConfigResource.instances:type_name -> compute.v1.InstanceResource
	26, // 57: compute.v1.OSUpdateRunResource.applied_policy:type_name -> compute.v1.OSUpdatePolicyResource
	23, // 58: compute.v1.OSUpdateRunResource.instance:type_name -> compute.v1.InstanceResource
	31, // 59: compute.v1.OSUpdateRunResource.status_indicator:type_name -> status.v1.StatusIndication
