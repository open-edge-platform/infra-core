...
var file_compute_v1_compute_proto_depIdxs = []int32{
	...
	25, // 31: compute.v1.InstanceResource.os:type_name -> os.v1.OperatingSystemResource
	26, // 32: compute.v1.InstanceResource.security_feature:type_name -> os.v1.SecurityFeature
	24, // 33: compute.v1.InstanceResource.instance_status_indicator:type_name -> status.v1.StatusIndication
	24, // 34: compute.v1.InstanceResource.provisioning_status_indicator:type_name -> status.v1.StatusIndication
	24, // 35: compute.v1.InstanceResource.update_status_indicator:type_name -> status.v1.StatusIndication
	24, // 36: compute.v1.InstanceResource.trusted_attestation_status_indicator:type_name -> status.v1.StatusIndication
	20, // 37: compute.v1.InstanceResource.workload_members:type_name -> compute.v1.WorkloadMember
	23, // 38: compute.v1.InstanceResource.provider:type_name -> provider.v1.ProviderResource
	27, // 39: compute.v1.InstanceResource.localaccount:type_name -> localaccount.v1.LocalAccountResource
	...
	25, // 48: compute.v1.OSUpdatePolicyResource.target_os:type_name -> os.v1.OperatingSystemResource
