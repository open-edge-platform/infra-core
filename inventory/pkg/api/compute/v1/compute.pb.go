...
const (
	...
	KvmStatus_KVM_STATUS_ACTIVATED   KvmStatus = 1 // A KVM remote session is currently active.
	KvmStatus_KVM_STATUS_DEACTIVATED KvmStatus = 2 // No KVM remote session is active.
)
...
const (
	...
	KvmState_KVM_STATE_START                KvmState = 1 // Desired: operator requests session start. Current: session is active.
	KvmState_KVM_STATE_STOP                 KvmState = 2 // Desired: operator requests session teardown. Current: terminated cleanly.
	KvmState_KVM_STATE_AWAITING_CONSENT     KvmState = 3 // Current only: kvm-manager triggered consent; waiting for operator to enter 6-digit code.
	KvmState_KVM_STATE_ERROR                KvmState = 4 // Current only: kvm-manager encountered an error.
	KvmState_KVM_STATE_CONSENT_RECEIVED     KvmState = 5 // Desired only: orch-cli has submitted the consent code directly to MPS; kvm-manager proceeds to token acquisition.
	KvmState_KVM_STATE_REDIRECTION_RECEIVED KvmState = 6 // Desired only: orch-cli has obtained the redirect token directly from MPS; kvm-manager updates current state to KVM_STATE_START.
)
...
var (
	KvmState_name = map[int32]string{
		...
		4: "KVM_STATE_ERROR",
		5: "KVM_STATE_CONSENT_RECEIVED",
		6: "KVM_STATE_REDIRECTION_RECEIVED",
	}
...
const (
	...
	SolState_SOL_STATE_START                SolState = 1 // Desired: operator requests session start. Current: session is active.
	SolState_SOL_STATE_STOP                 SolState = 2 // Desired: operator requests session teardown. Current: terminated cleanly.
	SolState_SOL_STATE_AWAITING_CONSENT     SolState = 3 // Current only: sol-manager triggered consent; waiting for operator to enter 6-digit code.
	SolState_SOL_STATE_ERROR                SolState = 4 // Current only: sol-manager encountered an error.
	SolState_SOL_STATE_CONSENT_RECEIVED     SolState = 5 // Desired only: orch-cli has submitted the consent code directly to MPS; sol-manager proceeds to token acquisition.
	SolState_SOL_STATE_REDIRECTION_RECEIVED SolState = 6 // Desired only: orch-cli has obtained the redirect token directly from MPS; sol-manager updates current state to SOL_STATE_START.
)
...
const (
	...
	SolStatus_SOL_STATUS_ACTIVATED   SolStatus = 1 // A SOL remote session is currently active.
	SolStatus_SOL_STATUS_DEACTIVATED SolStatus = 2 // No SOL remote session is active.
)
...
func (UpdatePolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_compute_v1_compute_proto_enumTypes[18].Descriptor()
}

func (UpdatePolicy) Type() protoreflect.EnumType {
	return &file_compute_v1_compute_proto_enumTypes[18]
}
...
type HostResource struct {
	...
	// KVM remote session activation status. Transitions to ACTIVATED on KVM_STATE_START; DEACTIVATED on KVM_STATE_STOP or KVM_STATE_ERROR.
	KvmStatus KvmStatus `protobuf:"varint,88,opt,name=kvm_status,json=kvmStatus,proto3,enum=compute.v1.KvmStatus" json:"kvm_status,omitempty"`
	// Desired KVM session state. Valid values: KVM_STATE_START, KVM_STATE_STOP, KVM_CONSENT_RECEIVED, KVM_REDIRECTION_RECEIVED.
	DesiredKvmState KvmState `protobuf:"varint,101,opt,name=desired_kvm_state,json=desiredKvmState,proto3,enum=compute.v1.KvmState" json:"desired_kvm_state,omitempty"`
	// Current KVM session state. Lifecycle: UNSPECIFIED → START → [AWAITING_CONSENT → START] | STOP | ERROR.
	CurrentKvmState KvmState `protobuf:"varint,102,opt,name=current_kvm_state,json=currentKvmState,proto3,enum=compute.v1.KvmState" json:"current_kvm_state,omitempty"`
	...
	// SOL remote session activation status. Transitions to ACTIVATED on SOL_STATE_START; DEACTIVATED on SOL_STATE_STOP or SOL_STATE_ERROR.
	SolStatus SolStatus `protobuf:"varint,106,opt,name=sol_status,json=solStatus,proto3,enum=compute.v1.SolStatus" json:"sol_status,omitempty"`
	// Desired SOL session state. Valid values: SOL_STATE_START, SOL_STATE_STOP, SOL_STATE_CONSENT_RECEIVED, SOL_STATE_REDIRECTION_RECEIVED.
	...
	// Current SOL session state. Lifecycle: UNSPECIFIED → START → [AWAITING_CONSENT → START] | STOP | ERROR.
...
var file_compute_v1_compute_proto_rawDesc = []byte{
	...
	0x22, 0x9e, 0x22, 0x0a, 0x0c, 0x48, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	,
	...
	0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x10, 0x73, 0x6f, 0x6c, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x32, 0x0a, 0x09, 0x74, 0x65, 0x6e, 0x61, 0x6e,
	...
	,
	...
	0x69, 0x6e, 0x64, 0x12, 0x2f, 0x0a, 0x0f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x5f,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x36, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01,
	...
	,
	...
	0x04, 0x08, 0x08, 0x10, 0x0b, 0x22, 0x95, 0x0a, 0x0a, 0x0f, 0x48, 0x6f, 0x73, 0x74, 0x6e, 0x69,
	0x63, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x48, 0x0a, 0x0b, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x27,
	0xba, 0x48, 0x1e, 0xd8, 0x01, 0x01, 0x72, 0x19, 0x28, 0x10, 0x32, 0x15, 0x5e, 0x68, 0x6f, 0x73,
	...
	0x65, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12,
	0x2f, 0x0a, 0x0f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01,
	0x52, 0x0e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x12, 0x36, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18,
	...
	0x18, 0x01, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x0b, 0x64, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x10, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba,
	...
	0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x12, 0x32, 0x0a, 0x09, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74,
	...
	0x00, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x4a, 0x04, 0x08, 0x08, 0x10, 0x0b, 0x22, 0x8a, 0x05,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x27, 0xba, 0x48, 0x1e, 0xd8, 0x01, 0x01, 0x72, 0x19,
	...
	0x0a, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x04, 0x6b,
	0x69, 0x6e, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08,
	0x01, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x36, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18,
	0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x22, 0x0a, 0x08, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73,
	0x18, 0x19, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x08,
	0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x12, 0x32, 0x0a, 0x09, 0x74, 0x65, 0x6e, 0x61,
	...
	0x64, 0x18, 0x00, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x22, 0xc9, 0x14, 0x0a, 0x10, 0x49, 0x6e,
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x45,
	0x0a, 0x0b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x24, 0xba, 0x48, 0x1b, 0xd8, 0x01, 0x01, 0x72, 0x16, 0x28, 0x0d, 0x32,
	...
	0x2e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x4b, 0x69, 0x6e, 0x64, 0x42, 0x06, 0xba,
	...
	0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x46, 0x0a, 0x0d, 0x64, 0x65, 0x73, 0x69, 0x72,
	0x65, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19,
	0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08,
	0x01, 0x52, 0x0c, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12,
	0x46, 0x0a, 0x0d, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65,
	...
	,
	...
	0x02, 0x08, 0x01, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x02, 0x6f, 0x73, 0x18,
	0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6f, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x70,
	...
	,
	...
	,
	...
	0x14, 0x20, 0x01, 0x28, 0x04, 0x42, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x52, 0x1b, 0x70,
	0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x36, 0x0a, 0x0d, 0x75, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x15, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x11, 0xba, 0x48, 0x08, 0xd8, 0x01, 0x01, 0x72, 0x03, 0x28, 0x80, 0x08, 0xba, 0xa6,
	0x49, 0x02, 0x08, 0x01, 0x52, 0x0c, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x12, 0x5b, 0x0a, 0x17, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x73, 0x74, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x08, 0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x12, 0x09, 0x54, 0x49, 0x4d, 0x45, 0x53,
	0x54, 0x41, 0x4d, 0x50, 0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x3a,
	0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x22, 0x99, 0x07, 0x0a, 0x16, 0x4f, 0x53, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x12, 0x4f, 0x0a, 0x0b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2e, 0xba, 0x48, 0x25, 0xd8, 0x01, 0x01, 0x72,
	...
	0x24, 0xba, 0xa6, 0x49, 0x02, 0x18, 0x01, 0x52, 0x0a, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x49, 0x64, 0x12, 0x48, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x34, 0xba, 0x48, 0x29, 0x72, 0x27, 0x28, 0x32, 0x32, 0x23, 0x5e, 0x24, 0x7c, 0x5e,
	...
	0xa6, 0x49, 0x04, 0x08, 0x00, 0x28, 0x00, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x57, 0x0a,
	0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x35, 0xba, 0x48, 0x2a, 0x72, 0x28, 0x28, 0xc8, 0x01, 0x32, 0x23, 0x5e, 0x24,
	...
	0x24, 0xba, 0xa6, 0x49, 0x04, 0x08, 0x01, 0x28, 0x00, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72,
	0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x6d, 0x0a, 0x0e, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x42, 0x46,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x2e,
	...
	0x01, 0x18, 0x00, 0x52, 0x0d, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64, 0x50, 0x6f, 0x6c, 0x69,
	0x63, 0x79, 0x12, 0x42, 0x0a, 0x08, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x05,
	...
	0x63, 0x65, 0x42, 0x08, 0xc2, 0xa6, 0x49, 0x04, 0x08, 0x01, 0x18, 0x01, 0x52, 0x08, 0x69, 0x6e,
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x50, 0x0a, 0x10, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x3a, 0x06, 0xba, 0xa6, 0x49, 0x02, 0x08, 0x01, 0x2a, 0x94, 0x01,
	...
	0x45, 0x5f, 0x52, 0x45, 0x47, 0x49, 0x53, 0x54, 0x45, 0x52, 0x45, 0x44, 0x10, 0x05, 0x22, 0x04,
	0x08, 0x01, 0x10, 0x01, 0x2a, 0xdc, 0x01, 0x0a, 0x0a, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x53, 0x74,
	...
	0x45, 0x52, 0x45, 0x44, 0x10, 0x02, 0x2a, 0xd3, 0x01, 0x0a, 0x17, 0x42, 0x61, 0x72, 0x65, 0x6d,
	...
	0x52, 0x5f, 0x4b, 0x49, 0x4e, 0x44, 0x5f, 0x50, 0x44, 0x55, 0x10, 0x04, 0x2a, 0x79, 0x0a, 0x08,
	...
	,
...
var file_compute_v1_compute_proto_enumTypes = make([]protoimpl.EnumInfo, 19)
...
var file_compute_v1_compute_proto_goTypes = []interface{}{
	...
	(KvmStatus)(0),                      // 7: compute.v1.KvmStatus
	(KvmState)(0),                       // 8: compute.v1.KvmState
	(SolState)(0),                       // 9: compute.v1.SolState
	(SolStatus)(0),                      // 10: compute.v1.SolStatus
	(HostComponentState)(0),             // 11: compute.v1.HostComponentState
	(NetworkInterfaceLinkState)(0),      // 12: compute.v1.NetworkInterfaceLinkState
	(InstanceState)(0),                  // 13: compute.v1.InstanceState
	(InstanceKind)(0),                   // 14: compute.v1.InstanceKind
	(WorkloadState)(0),                  // 15: compute.v1.WorkloadState
	(WorkloadKind)(0),                   // 16: compute.v1.WorkloadKind
	(WorkloadMemberKind)(0),             // 17: compute.v1.WorkloadMemberKind
	(UpdatePolicy)(0),                   // 18: compute.v1.UpdatePolicy
	(*HostResource)(nil),                // 19: compute.v1.HostResource
	(*HoststorageResource)(nil),         // 20: compute.v1.HoststorageResource
	(*HostnicResource)(nil),             // 21: compute.v1.HostnicResource
	(*HostusbResource)(nil),             // 22: compute.v1.HostusbResource
	(*HostgpuResource)(nil),             // 23: compute.v1.HostgpuResource
	(*InstanceResource)(nil),            // 24: compute.v1.InstanceResource
	(*WorkloadResource)(nil),            // 25: compute.v1.WorkloadResource
	(*WorkloadMember)(nil),              // 26: compute.v1.WorkloadMember
	(*OSUpdatePolicyResource)(nil),      // 27: compute.v1.OSUpdatePolicyResource
	(*CustomConfigResource)(nil),        // 28: compute.v1.CustomConfigResource
	(*OSUpdateRunResource)(nil),         // 29: compute.v1.OSUpdateRunResource
	(*v1.SiteResource)(nil),             // 30: location.v1.SiteResource
	(*v11.ProviderResource)(nil),        // 31: provider.v1.ProviderResource
	(v12.StatusIndication)(0),           // 32: status.v1.StatusIndication
	(*v13.OperatingSystemResource)(nil), // 33: os.v1.OperatingSystemResource
	(v13.SecurityFeature)(0),            // 34: os.v1.SecurityFeature
	(*v14.LocalAccountResource)(nil),    // 35: localaccount.v1.LocalAccountResource
}
var file_compute_v1_compute_proto_depIdxs = []int32{
	...
	30, // 2: compute.v1.HostResource.site:type_name -> location.v1.SiteResource
	31, // 3: compute.v1.HostResource.provider:type_name -> provider.v1.ProviderResource
	...
	32, // 7: compute.v1.HostResource.power_status_indicator:type_name -> status.v1.StatusIndication
	2,  // 8: compute.v1.HostResource.power_command_policy:type_name -> compute.v1.PowerCommandPolicy
	32, // 9: compute.v1.HostResource.host_status_indicator:type_name -> status.v1.StatusIndication
	32, // 10: compute.v1.HostResource.onboarding_status_indicator:type_name -> status.v1.StatusIndication
	32, // 11: compute.v1.HostResource.registration_status_indicator:type_name -> status.v1.StatusIndication
	20, // 12: compute.v1.HostResource.host_storages:type_name -> compute.v1.HoststorageResource
	21, // 13: compute.v1.HostResource.host_nics:type_name -> compute.v1.HostnicResource
	22, // 14: compute.v1.HostResource.host_usbs:type_name -> compute.v1.HostusbResource
	23, // 15: compute.v1.HostResource.host_gpus:type_name -> compute.v1.HostgpuResource
	24, // 16: compute.v1.HostResource.instance:type_name -> compute.v1.InstanceResource
	...
	32, // 20: compute.v1.HostResource.amt_status_indicator:type_name -> status.v1.StatusIndication
	6,  // 21: compute.v1.HostResource.amt_control_mode:type_name -> compute.v1.AmtControlMode
	7,  // 22: compute.v1.HostResource.kvm_status:type_name -> compute.v1.KvmStatus
	8,  // 23: compute.v1.HostResource.desired_kvm_state:type_name -> compute.v1.KvmState
	8,  // 24: compute.v1.HostResource.current_kvm_state:type_name -> compute.v1.KvmState
	10, // 25: compute.v1.HostResource.sol_status:type_name -> compute.v1.SolStatus
	9,  // 26: compute.v1.HostResource.desired_sol_state:type_name -> compute.v1.SolState
	9,  // 27: compute.v1.HostResource.current_sol_state:type_name -> compute.v1.SolState
	19, // 28: compute.v1.HoststorageResource.host:type_name -> compute.v1.HostResource
	19, // 29: compute.v1.HostnicResource.host:type_name -> compute.v1.HostResource
	12, // 30: compute.v1.HostnicResource.link_state:type_name -> compute.v1.NetworkInterfaceLinkState
	19, // 31: compute.v1.HostusbResource.host:type_name -> compute.v1.HostResource
	19, // 32: compute.v1.HostgpuResource.host:type_name -> compute.v1.HostResource
	14, // 33: compute.v1.InstanceResource.kind:type_name -> compute.v1.InstanceKind
	13, // 34: compute.v1.InstanceResource.desired_state:type_name -> compute.v1.InstanceState
	13, // 35: compute.v1.InstanceResource.current_state:type_name -> compute.v1.InstanceState
	19, // 36: compute.v1.InstanceResource.host:type_name -> compute.v1.HostResource
	33, // 37: compute.v1.InstanceResource.os:type_name -> os.v1.OperatingSystemResource
	34, // 38: compute.v1.InstanceResource.security_feature:type_name -> os.v1.SecurityFeature
	32, // 39: compute.v1.InstanceResource.instance_status_indicator:type_name -> status.v1.StatusIndication
	32, // 40: compute.v1.InstanceResource.provisioning_status_indicator:type_name -> status.v1.StatusIndication
	32, // 41: compute.v1.InstanceResource.update_status_indicator:type_name -> status.v1.StatusIndication
	32, // 42: compute.v1.InstanceResource.trusted_attestation_status_indicator:type_name -> status.v1.StatusIndication
	26, // 43: compute.v1.InstanceResource.workload_members:type_name -> compute.v1.WorkloadMember
	31, // 44: compute.v1.InstanceResource.provider:type_name -> provider.v1.ProviderResource
	35, // 45: compute.v1.InstanceResource.localaccount:type_name -> localaccount.v1.LocalAccountResource
	27, // 46: compute.v1.InstanceResource.os_update_policy:type_name -> compute.v1.OSUpdatePolicyResource
	28, // 47: compute.v1.InstanceResource.custom_config:type_name -> compute.v1.CustomConfigResource
	16, // 48: compute.v1.WorkloadResource.kind:type_name -> compute.v1.WorkloadKind
	15, // 49: compute.v1.WorkloadResource.desired_state:type_name -> compute.v1.WorkloadState
	15, // 50: compute.v1.WorkloadResource.current_state:type_name -> compute.v1.WorkloadState
	26, // 51: compute.v1.WorkloadResource.members:type_name -> compute.v1.WorkloadMember
	17, // 52: compute.v1.WorkloadMember.kind:type_name -> compute.v1.WorkloadMemberKind
	25, // 53: compute.v1.WorkloadMember.workload:type_name -> compute.v1.WorkloadResource
	24, // 54: compute.v1.WorkloadMember.instance:type_name -> compute.v1.InstanceResource
	33, // 55: compute.v1.OSUpdatePolicyResource.target_os:type_name -> os.v1.OperatingSystemResource
	18, // 56: compute.v1.OSUpdatePolicyResource.update_policy:type_name -> compute.v1.UpdatePolicy
	24, // 57: compute.v1.CustomConfigResource.instances:type_name -> compute.v1.InstanceResource
	27, // 58: compute.v1.OSUpdateRunResource.applied_policy:type_name -> compute.v1.OSUpdatePolicyResource
	24, // 59: compute.v1.OSUpdateRunResource.instance:type_name -> compute.v1.InstanceResource
	32, // 60: compute.v1.OSUpdateRunResource.status_indicator:type_name -> status.v1.StatusIndication
