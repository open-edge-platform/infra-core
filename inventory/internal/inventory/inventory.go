...
func (srv *InventorygRPCServer) CreateResource(
	...
	case *inv_v1.Resource_HostAmtconfig:
		res, err = srv.IS.CreateHostamtconfig(ctx, in.GetResource().GetHostAmtconfig())
...
func (srv *InventorygRPCServer) GetResource(
	...
	case inv_v1.ResourceKind_RESOURCE_KIND_HOSTAMTCONFIG:
		gresresp.Resource, err = srv.IS.GetHostamtconfig(ctx, in.ResourceId)
...
func (srv *InventorygRPCServer) doUpdateResource(
	...
	case inv_v1.ResourceKind_RESOURCE_KIND_HOSTAMTCONFIG:
		res, err = srv.IS.UpdateHostamtconfig(ctx, in.ResourceId, in.GetResource().GetHostAmtconfig(), in.GetFieldMask())
...
func (srv *InventorygRPCServer) doDeleteResource(
	...
	case inv_v1.ResourceKind_RESOURCE_KIND_HOSTAMTCONFIG:
		res, err = srv.IS.DeleteHostamtconfig(ctx, in.ResourceId)
...
var deleteResourcesHandlers = map[inv_v1.ResourceKind]deleteResourcesHandlerProvider{
	...
	inv_v1.ResourceKind_RESOURCE_KIND_HOSTAMTCONFIG:     func(is *store.InvStore) deleteResourcesHandler { return is.DeleteHostAmtconfigs },
