...
func (_d *RemoteAccessConfigurationDelete) Where(ps ...predicate.RemoteAccessConfiguration) *RemoteAccessConfigurationDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *RemoteAccessConfigurationDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *RemoteAccessConfigurationDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *RemoteAccessConfigurationDelete) sqlExec(ctx context.Context) (int, error) {
...
type RemoteAccessConfigurationDeleteOne struct {
	_d *RemoteAccessConfigurationDelete
}

// Where appends a list predicates to the RemoteAccessConfigurationDelete builder.
func (_d *RemoteAccessConfigurationDeleteOne) Where(ps ...predicate.RemoteAccessConfiguration) *RemoteAccessConfigurationDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *RemoteAccessConfigurationDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *RemoteAccessConfigurationDeleteOne) ExecX(ctx context.Context) {
