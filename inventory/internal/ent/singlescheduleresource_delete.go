...
func (_d *SingleScheduleResourceDelete) Where(ps ...predicate.SingleScheduleResource) *SingleScheduleResourceDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *SingleScheduleResourceDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *SingleScheduleResourceDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *SingleScheduleResourceDelete) sqlExec(ctx context.Context) (int, error) {
...
type SingleScheduleResourceDeleteOne struct {
	_d *SingleScheduleResourceDelete
}

// Where appends a list predicates to the SingleScheduleResourceDelete builder.
func (_d *SingleScheduleResourceDeleteOne) Where(ps ...predicate.SingleScheduleResource) *SingleScheduleResourceDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *SingleScheduleResourceDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *SingleScheduleResourceDeleteOne) ExecX(ctx context.Context) {
