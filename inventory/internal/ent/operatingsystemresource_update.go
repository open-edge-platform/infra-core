...
func (osru *OperatingSystemResourceUpdate) SetExistingCvesURL(s string) *OperatingSystemResourceUpdate {
	osru.mutation.SetExistingCvesURL(s)
	return osru
}

// SetNillableExistingCvesURL sets the "existing_cves_url" field if the given value is not nil.
func (osru *OperatingSystemResourceUpdate) SetNillableExistingCvesURL(s *string) *OperatingSystemResourceUpdate {
	if s != nil {
		osru.SetExistingCvesURL(*s)
	}
	return osru
}

// ClearExistingCvesURL clears the value of the "existing_cves_url" field.
func (osru *OperatingSystemResourceUpdate) ClearExistingCvesURL() *OperatingSystemResourceUpdate {
	osru.mutation.ClearExistingCvesURL()
	return osru
}
...
func (osru *OperatingSystemResourceUpdate) SetFixedCvesURL(s string) *OperatingSystemResourceUpdate {
	osru.mutation.SetFixedCvesURL(s)
	return osru
}

// SetNillableFixedCvesURL sets the "fixed_cves_url" field if the given value is not nil.
func (osru *OperatingSystemResourceUpdate) SetNillableFixedCvesURL(s *string) *OperatingSystemResourceUpdate {
	if s != nil {
		osru.SetFixedCvesURL(*s)
	}
	return osru
}

// ClearFixedCvesURL clears the value of the "fixed_cves_url" field.
func (osru *OperatingSystemResourceUpdate) ClearFixedCvesURL() *OperatingSystemResourceUpdate {
	osru.mutation.ClearFixedCvesURL()
	return osru
}
...
func (osru *OperatingSystemResourceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := osru.mutation.ExistingCvesURL(); ok {
	...
	if value, ok := osru.mutation.FixedCvesURL(); ok {
...
// SetExistingCvesURL sets the "existing_cves_url" field.
func (osruo *OperatingSystemResourceUpdateOne) SetExistingCvesURL(s string) *OperatingSystemResourceUpdateOne {
	osruo.mutation.SetExistingCvesURL(s)
	return osruo
}

// SetNillableExistingCvesURL sets the "existing_cves_url" field if the given value is not nil.
func (osruo *OperatingSystemResourceUpdateOne) SetNillableExistingCvesURL(s *string) *OperatingSystemResourceUpdateOne {
	if s != nil {
		osruo.SetExistingCvesURL(*s)
	}
	return osruo
}

// ClearExistingCvesURL clears the value of the "existing_cves_url" field.
func (osruo *OperatingSystemResourceUpdateOne) ClearExistingCvesURL() *OperatingSystemResourceUpdateOne {
	osruo.mutation.ClearExistingCvesURL()
	return osruo
}
...
// SetFixedCvesURL sets the "fixed_cves_url" field.
func (osruo *OperatingSystemResourceUpdateOne) SetFixedCvesURL(s string) *OperatingSystemResourceUpdateOne {
	osruo.mutation.SetFixedCvesURL(s)
	return osruo
}

// SetNillableFixedCvesURL sets the "fixed_cves_url" field if the given value is not nil.
func (osruo *OperatingSystemResourceUpdateOne) SetNillableFixedCvesURL(s *string) *OperatingSystemResourceUpdateOne {
	if s != nil {
		osruo.SetFixedCvesURL(*s)
	}
	return osruo
}

// ClearFixedCvesURL clears the value of the "fixed_cves_url" field.
func (osruo *OperatingSystemResourceUpdateOne) ClearFixedCvesURL() *OperatingSystemResourceUpdateOne {
	osruo.mutation.ClearFixedCvesURL()
	return osruo
}
...
func (osruo *OperatingSystemResourceUpdateOne) sqlSave(ctx context.Context) (_node *OperatingSystemResource, err error) {
	...
	if value, ok := osruo.mutation.ExistingCvesURL(); ok {
		_spec.SetField(operatingsystemresource.FieldExistingCvesURL, field.TypeString, value)
	}
	...
	if value, ok := osruo.mutation.FixedCvesURL(); ok {
		_spec.SetField(operatingsystemresource.FieldFixedCvesURL, field.TypeString, value)
	}
