...
const (
	// Label holds the string label denoting the osupdatepolicy type in the database.
	Label = "os_update_policy"
	...
	// Table holds the table name of the osupdatepolicy in the database.
	Table = "os_update_policies"
	// TargetOsTable is the table that holds the target_os relation/edge.
	TargetOsTable = "os_update_policies"
	...
	TargetOsColumn = "os_update_policy_target_os"
)

// Columns holds all SQL columns for osupdatepolicy fields.
var Columns = []string{
	FieldID,
	FieldResourceID,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "os_update_policies"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"os_update_policy_target_os",
}
...
func UpdatePolicyValidator(up UpdatePolicy) error {
	...
	case UpdatePolicyUPDATE_POLICY_UNSPECIFIED, UpdatePolicyUPDATE_POLICY_LATEST, UpdatePolicyUPDATE_POLICY_TARGET:
		return nil
	default:
		return fmt.Errorf("osupdatepolicy: invalid enum value for update_policy field: %q", up)
	}
}

// OrderOption defines the ordering options for the OSUpdatePolicy queries.
