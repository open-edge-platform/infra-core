...
func (HostResource) Edges() []ent.Edge {
	return []ent.Edge{edge.To("site", SiteResource.Type).Unique(), edge.To("provider", ProviderResource.Type).Unique(), edge.From("host_storages", HoststorageResource.Type).Ref("host"), edge.From("host_nics", HostnicResource.Type).Ref("host"), edge.From("host_usbs", HostusbResource.Type).Ref("host"), edge.From("host_gpus", HostgpuResource.Type).Ref("host"), edge.From("host_amtconfig", HostamtconfigResource.Type).Ref("host"), edge.From("instance", InstanceResource.Type).Ref("host").Unique()}
}
