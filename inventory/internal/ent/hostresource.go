...
type HostResourceEdges struct {
	...
	// HostAmtconfig holds the value of the host_amtconfig edge.
	HostAmtconfig []*HostamtconfigResource `json:"host_amtconfig,omitempty"`
...
// HostAmtconfigOrErr returns the HostAmtconfig value or an error if the edge
// was not loaded in eager-loading.
func (e HostResourceEdges) HostAmtconfigOrErr() ([]*HostamtconfigResource, error) {
	if e.loadedTypes[6] {
		return e.HostAmtconfig, nil
	}
	return nil, &NotLoadedError{edge: "host_amtconfig"}
}
...
// QueryHostAmtconfig queries the "host_amtconfig" edge of the HostResource entity.
func (_m *HostResource) QueryHostAmtconfig() *HostamtconfigResourceQuery {
	return NewHostResourceClient(_m.config).QueryHostAmtconfig(_m)
}
