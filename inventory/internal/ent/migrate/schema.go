...
var (
	...
	HostResourcesColumns = []*schema.Column{
		...
		{Name: "desired_kvm_state", Type: field.TypeEnum, Nullable: true, Enums: []string{"KVM_STATE_UNSPECIFIED", "KVM_STATE_START", "KVM_STATE_STOP", "KVM_STATE_AWAITING_CONSENT", "KVM_STATE_ERROR"}},
		{Name: "current_kvm_state", Type: field.TypeEnum, Nullable: true, Enums: []string{"KVM_STATE_UNSPECIFIED", "KVM_STATE_START", "KVM_STATE_STOP", "KVM_STATE_AWAITING_CONSENT", "KVM_STATE_ERROR"}},
		{Name: "kvm_session_url", Type: field.TypeString, Nullable: true},
		{Name: "kvm_session_status", Type: field.TypeString, Nullable: true},
		{Name: "kvm_session_status_indicator", Type: field.TypeEnum, Nullable: true, Enums: []string{"STATUS_INDICATION_UNSPECIFIED", "STATUS_INDICATION_ERROR", "STATUS_INDICATION_IN_PROGRESS", "STATUS_INDICATION_IDLE"}},
