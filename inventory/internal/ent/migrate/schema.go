...
var (
	...
	HostResourcesColumns = []*schema.Column{
		...
		{Name: "sol_session_status", Type: field.TypeEnum, Nullable: true, Enums: []string{"SOL_SESSION_UNSPECIFIED", "SOL_SESSION_ACTIVATED", "SOL_SESSION_DEACTIVATED"}},
	...
	HostResourcesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{HostResourcesColumns[62]},
			},
		},
	}
