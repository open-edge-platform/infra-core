...
var (
	...
	// HostamtconfigResourcesColumns holds the columns for the "hostamtconfig_resources" table.
	HostamtconfigResourcesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "resource_id", Type: field.TypeString, Unique: true},
		{Name: "kind", Type: field.TypeString, Nullable: true},
		...
		{Name: "created_at", Type: field.TypeString, SchemaType: map[string]string{"postgres": "TIMESTAMP"}},
		{Name: "updated_at", Type: field.TypeString, SchemaType: map[string]string{"postgres": "TIMESTAMP"}},
		{Name: "hostamtconfig_resource_host", Type: field.TypeInt},
	}
	// HostamtconfigResourcesTable holds the schema information for the "hostamtconfig_resources" table.
	HostamtconfigResourcesTable = &schema.Table{
		Name:       "hostamtconfig_resources",
		Columns:    HostamtconfigResourcesColumns,
		PrimaryKey: []*schema.Column{HostamtconfigResourcesColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "hostamtconfig_resources_host_resources_host",
				Columns:    []*schema.Column{HostamtconfigResourcesColumns[19]},
				RefColumns: []*schema.Column{HostResourcesColumns[0]},
		...
		Indexes: []*schema.Index{
			{
				Name:    "hostamtconfigresource_tenant_id",
				Unique:  false,
				Columns: []*schema.Column{HostamtconfigResourcesColumns[16]},
			},
		},
	}
...
func init() {
	...
	HostamtconfigResourcesTable.ForeignKeys[0].RefTable = HostResourcesTable
