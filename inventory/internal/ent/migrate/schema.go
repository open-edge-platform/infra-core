...
var (
	...
	HostResourcesColumns = []*schema.Column{
		...
		{Name: "desired_amt_state", Type: field.TypeEnum, Nullable: true, Enums: []string{"AMT_STATE_UNSPECIFIED", "AMT_STATE_PROVISION", "AMT_STATE_UNPROVISION", "AMT_STATE_DISCONNECT"}},
		{Name: "current_amt_state", Type: field.TypeEnum, Nullable: true, Enums: []string{"AMT_STATE_UNSPECIFIED", "AMT_STATE_PROVISION", "AMT_STATE_UNPROVISION", "AMT_STATE_DISCONNECT"}},
