...
// The HostamtconfigResourceFunc type is an adapter to allow the use of ordinary function as a Querier.
type HostamtconfigResourceFunc func(context.Context, *ent.HostamtconfigResourceQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f HostamtconfigResourceFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.HostamtconfigResourceQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.HostamtconfigResourceQuery", q)
}

// The TraverseHostamtconfigResource type is an adapter to allow the use of ordinary function as Traverser.
type TraverseHostamtconfigResource func(context.Context, *ent.HostamtconfigResourceQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseHostamtconfigResource) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseHostamtconfigResource) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.HostamtconfigResourceQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.HostamtconfigResourceQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.HostamtconfigResourceQuery:
		return &query[*ent.HostamtconfigResourceQuery, predicate.HostamtconfigResource, hostamtconfigresource.OrderOption]{typ: ent.TypeHostamtconfigResource, tq: q}, nil
