...
| SOL_SESSION_ACTIVATED | 1 | SOL feature is currently enabled on the AMT device. |
| SOL_SESSION_DEACTIVATED | 2 | SOL feature is currently disabled on the AMT device. |
