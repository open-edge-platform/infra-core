...
- [compute/v1/compute.proto](#compute_v1_compute-proto)
    ...
    - [HostamtconfigResource](#compute-v1-HostamtconfigResource)
    ...
    - [OSUpdateRunResource](#compute-v1-OSUpdateRunResource)
...
| host_amtconfig | [HostamtconfigResource](#compute-v1-HostamtconfigResource) |  | Back-reference to attached host AMT/vPRO settings. This edge is read-only. |
...
<a name="compute-v1-HostamtconfigResource"></a>
...
| host | [HostResource](#compute-v1-HostResource) |  | The Host where the AMT/vPRO settings are applied. |
| version | [string](#string) |  | Version number of AMT/vPRO on the host. |
| device_name | [string](#string) |  | Device name of host. |
| operational_state | [string](#string) |  | Operational state of AMT/vPRO on the host, either enabled or disabled. |
| build_number | [string](#string) |  | Build number of AMT/vPRO on the host. |
| sku | [string](#string) |  | Integer number of the SKU of the host. |
| features | [string](#string) |  | AMT/vPRO features available on host. |
...
| network_status | [string](#string) |  | Networking status for AMT/vPRO RAS on host. |
| remote_status | [string](#string) |  | Remote connection status for AMT/vPRO RAS on host. |
| remote_trigger | [string](#string) |  | Trigger for enabling remote connection for AMT/vPRO RAS on host. |
...
| host_amtconfig | [compute.v1.HostamtconfigResource](#compute-v1-HostamtconfigResource) |  |  |
