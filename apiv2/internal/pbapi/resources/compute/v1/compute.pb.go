...
type InstanceResource struct {
	...
	Os *v14.OperatingSystemResource `protobuf:"bytes,10,opt,name=os,proto3" json:"os,omitempty"`
	// OS resource that should be installed to this Instance.
...
func (x *InstanceResource) GetOs() *v14.OperatingSystemResource {
	if x != nil {
		return x.Os
	}
	return nil
...
var file_resources_compute_v1_compute_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x73, 0x22, 0xc2, 0x11, 0x0a, 0x10, 0x49, 0x6e, 0x73, 0x74, 0x61,
...
var file_resources_compute_v1_compute_proto_depIdxs = []int32{
	...
	22, // 25: resources.compute.v1.InstanceResource.os:type_name -> resources.os.v1.OperatingSystemResource
	22, // 26: resources.compute.v1.InstanceResource.desired_os:type_name -> resources.os.v1.OperatingSystemResource
	22, // 27: resources.compute.v1.InstanceResource.current_os:type_name -> resources.os.v1.OperatingSystemResource
	23, // 28: resources.compute.v1.InstanceResource.security_feature:type_name -> resources.os.v1.SecurityFeature
	18, // 29: resources.compute.v1.InstanceResource.instance_status_indicator:type_name -> resources.status.v1.StatusIndication
	18, // 30: resources.compute.v1.InstanceResource.provisioning_status_indicator:type_name -> resources.status.v1.StatusIndication
	18, // 31: resources.compute.v1.InstanceResource.update_status_indicator:type_name -> resources.status.v1.StatusIndication
	18, // 32: resources.compute.v1.InstanceResource.trusted_attestation_status_indicator:type_name -> resources.status.v1.StatusIndication
	16, // 33: resources.compute.v1.InstanceResource.workload_members:type_name -> resources.compute.v1.WorkloadMember
	24, // 34: resources.compute.v1.InstanceResource.localaccount:type_name -> resources.localaccount.v1.LocalAccountResource
