...
type HostRegister struct {
	...
	// LVM size in GB
	LvmSize string `protobuf:"bytes,20,opt,name=lvm_size,json=lvmSize,proto3" json:"lvm_size,omitempty"`
}
...
func (x *HostRegister) GetLvmSize() string {
	if x != nil {
		return x.LvmSize
	}
	return ""
...
var file_services_v1_services_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x7a, 0x65, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6c, 0x76, 0x6d, 0x53,
