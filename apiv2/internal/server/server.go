...
// Each function registers the service implementation with the gRPC server.
// Keys must match the protobuf service names.
// setupServices() filters and registers only the services allowed for the active SCENARIO.
