...
type CreateSiteRequest struct {
	...
	// (OPTIONAL) Optional region ID for hierarchical path support
...
type HostResource struct {
	...
	// (OPTIONAL) WebSocket URL for the active SOL session.
...
type ListCustomConfigsRequest struct {
	...
	// (OPTIONAL) Index of the first item to return. This allows skipping items.
...
type ListLocationsRequest struct {
	// (OPTIONAL) Filter locations by name
	Name *string `json:"name,omitempty"`

	// Project name
	ProjectName string `json:"projectName"`

	// (OPTIONAL) Return region locations
	ShowRegions *bool `json:"showRegions,omitempty"`

	// (OPTIONAL) Return site locations
...
type ListRegionsRequest struct {
	...
	// (OPTIONAL) Flag to signal if the total amount of site in a region should be returned.
...
type ListRepeatedSchedulesRequest struct {
	...
	// (OPTIONAL) Filter based on the timestamp, expected to be UNIX epoch UTC timestamp in seconds.
...
type ListTelemetryLogsProfilesRequest struct {
	// (OPTIONAL) Returns only the telemetry profiles that are assigned with the given instance identifier.
	// string.max_bytes = 13
	InstanceId *string `json:"instanceId,omitempty"`
	...
	// (OPTIONAL) Returns only the telemetry profiles that are assigned with the given regionID.
	// string.max_bytes = 15
	RegionId *string `json:"regionId,omitempty"`
	...
	// (OPTIONAL) Returns only the telemetry profiles that are assigned with the given siteID.
	// string.max_bytes = 13
	SiteId *string `json:"siteId,omitempty"`
}
