...
func TestSchedRepeated_CreateGetDelete(t *testing.T) {
	...
	RepeatedSched1 := CreateSchedRepeated(ctx, t, apiClient, utils.RepeatedSchedule1Request)

	utils.RepeatedSchedule2Request.TargetSiteId = siteCreated1.JSON200.ResourceId
	RepeatedSched2 := CreateSchedRepeated(ctx, t, apiClient, utils.RepeatedSchedule1Request)
...
func TestSchedRepeatedList(t *testing.T) {
	...
	for id := 0; id < totalItems; id++ {
		CreateSchedRepeated(ctx, t, apiClient, utils.RepeatedSchedule1Request)
	}
	...
	assert.Equal(t, pageSize, len(resList.JSON200.RepeatedSchedules))
...
func TestSchedRepeatedListQuery(t *testing.T) {
	...
	CreateSchedRepeated(ctx, t, apiClient, utils.RepeatedSchedule2Request)

	utils.RepeatedSchedule3Request.TargetSiteId = postRespSite2.JSON200.ResourceId
	CreateSchedRepeated(ctx, t, apiClient, utils.RepeatedSchedule3Request)
...
func TestSchedRepeatedMaintenanceQuery(t *testing.T) {
	...
	CreateSchedRepeated(ctx, t, apiClient, utils.RepeatedScheduleAlwaysRequest)
