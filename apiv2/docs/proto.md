...
| kernel_command | [string](#string) |  | **Deprecated.** The OS resource&#39;s kernel Command Line Options. |
| update_sources | [string](#string) | repeated | **Deprecated.** The list of OS resource update sources. Should be in &#39;DEB822 Source Format&#39; for Debian style OSs |
