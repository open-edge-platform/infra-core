...
func Test_InstanceHandler_Patch(t *testing.T) {
	...
	osResource1 := inv_testing.CreateOsWithArgs(t, inv_testing.RandomSha256v1, "Test OS 1 for Instance Patch", "Test Profile 1", os_v1.SecurityFeature_SECURITY_FEATURE_UNSPECIFIED, os_v1.OsType_OS_TYPE_MUTABLE)
	osResource2 := inv_testing.CreateOsWithArgs(t, inv_testing.RandomSha256v2, "Test OS 2 for Instance Patch", "Test Profile 2", os_v1.SecurityFeature_SECURITY_FEATURE_UNSPECIFIED, os_v1.OsType_OS_TYPE_MUTABLE)
